...
def layout (content):
    ...
    extend_([u'        <link rel="stylesheet" href="static/bootstrap.min.css" title="" type="text/css" />\n'])
    extend_([u'        <link rel="stylesheet" href="static/bootstrap-theme.min.css" title="" type="text/css" />\n'])
    extend_([u'    </head>\n'])
    extend_([u'    <body>\n'])
